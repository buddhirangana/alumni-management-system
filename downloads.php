...
<head>
    ...
    <title>Downloads | Alumni Association SICT</title>
        ...
        <div class="row mb-5 pb-2 mt-4 text-center">
            <div class="col-md-3 mb-3 hidden">
                <div class="card h-100 border-1">
                    <div class="card-body p-4">
                        ...
                        <p class="card-text card-text-1 mt-2" style="font-size: 19px;">Constitution of the Alumni</p>
            ...
            <div class="col-md-3 mb-3 hidden">
                <div class="card h-100 border-1">
                    <div class="card-body p-4">
                        <i class="bi bi-filetype-pdf" style="font-size: 70px;"></i>
                        <p class="card-text card-text-1 mt-2" style="font-size: 19px;">Membership Application</p>
                        <a href="#!" class="hidden"><button type="button" class="btn calltoactionbtn w-50 mt-2">Download</button></a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3 hidden">
                <div class="card h-100 border-1">
                    <div class="card-body p-4">
                        <i class="bi bi-filetype-pdf" style="font-size: 70px;"></i>
                        <p class="card-text card-text-1 mt-2" style="font-size: 19px;">Annual Report 2022 - 2023</p>
                        <a href="#!" class="hidden"><button type="button" class="btn calltoactionbtn w-50 mt-2">Download</button></a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3 hidden">
                <div class="card h-100 border-1">
                    <div class="card-body p-4">
                        <i class="bi bi-filetype-pdf" style="font-size: 70px;"></i>
                        <p class="card-text card-text-1 mt-2" style="font-size: 19px;">Annual Report 2023 - 2024</p>
                        <a href="#!" class="hidden"><button type="button" class="btn calltoactionbtn w-50 mt-2">Download</button></a>
                    </div>
                </div>
            </div>
